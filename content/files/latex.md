...
The same goes for the page containing key document information.
...
Should you need some other page with a complex format, it's better to write it in a WYSIWYG editor and import the PDF output using the [pdfpages](https://www.ctan.org/pkg/pdfpages) package:
